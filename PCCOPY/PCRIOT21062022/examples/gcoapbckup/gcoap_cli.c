...
static ssize_t _riot_board1_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, void *ctx);
static ssize_t _rpl_table_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, void *ctx);
static ssize_t _riot_board_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, void *ctx);
static ssize_t _systime_handler(coap_pkt_t* pdu, uint8_t *buf, size_t len, void *ctx);
...
static const coap_resource_t _resources[] = {
    ...
    { "/riot/b", COAP_GET, _riot_board1_handler, NULL },
...
/*radio on/off through calling netapi--NETOPT_STATE_SLEEP & NETOPT_STATE_IDLE*/
...
// void _periodic_sleep (double hour, double minute){
//     radio_off();
//     puts("Radio is sleeping...");

//     uint32_t start = rtt_get_counter();
//     rtt_set_alarm((start + 60*minute * RTT_FREQUENCY) & RTT_MAX_VALUE, callback, 0);
//     puts("Alarm set, sleeping");
    
//     pm_set(1);
//     printf("Power Mode is: 1\n");
